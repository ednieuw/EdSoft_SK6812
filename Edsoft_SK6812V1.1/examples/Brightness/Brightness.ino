...
const byte LED_PIN   = 5;                                      // Pin number LEDs are connected to
...
void setup() 
{
 LED.setBrightness(128);                                        // Set brightness of LEDs
}
//------------------------------------------------------------------------------
//  Loop
//------------------------------------------------------------------------------
...
void loop() 
{
 static byte luminosity = 128;
 WhiteOverRainbow(50, 100, 5 );                           // wait, whiteSpeed, whiteLength
 LED.setBrightness(luminosity+=53);
}
